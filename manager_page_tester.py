...
class ManagerPageTester:
    ...
    def go_to_job_nav(self):
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="root"]/header/div/button').click()
        time.sleep(1)
        self.driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/ul/li[1]').click()
        time.sleep(2)

    def go_to_workers_nav(self):
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="root"]/header/div/button').click()
        time.sleep(1)
        self.driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/ul/li[2]').click()
        time.sleep(2)

    def go_to_worker_detail(self):
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div/div[2]/table/tbody/tr/td[1]').click()
        time.sleep(2)
    ...
    def run_test(self):
        ...
        self.go_to_job_nav()
        self.go_to_workers_nav()
        self.go_to_worker_detail()
...
if __name__ == "__main__":
    ...
    manager_page_tester = ManagerPageTester(chrome_driver)
    manager_page_tester.run_test()
